...
execute if block ~ ~ ~ air run tp @e[tag=eden.fish_bullet] ~ ~ ~
...
execute unless block ~ ~ ~ air run kill @e[tag=eden.fish_bullet]
execute unless entity @s[distance=..32] run kill @e[tag=eden.fish_bullet]
