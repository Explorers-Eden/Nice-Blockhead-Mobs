execute at @e[type=minecraft:pillager,tag=eden.penguin,limit=1,sort=nearest,nbt={HurtTime:10s}] run particle angry_villager ~ ~1.3 ~ .3 .3 .3 0 5
...
execute at @e[type=minecraft:pillager,tag=eden.penguin,limit=1,sort=nearest,nbt={HurtTime:10s}] run playsound minecraft:entity.chicken.hurt neutral @a ~ ~ ~ .6 .2
